...
public class Test : MonoBehaviour
{
    ...
    public float speedSohran = 150;
    public float speedDash = 1500;
    public bool DashLook = true;
    ...
    void Update()
    {
        ...
        if(lookAtCursor == true)
        {
            ...
            if (Input.GetKey(DashButton) && DashLook == true)
            {
                DashLook = false;
                StartCoroutine(Coruten());
            }
