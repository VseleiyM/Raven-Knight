...
namespace Project.GenerateLevel
{
    public class GenerateLevel : MonoBehaviour
    {
        ...
        public int Wave1Diff => _wave1Diff;
        [SerializeField, Min(0)] private int _wave1Diff;
        public int Wave2Diff => _wave2Diff;
        [SerializeField, Min(-1)] private int _wave2Diff;
        public int Wave3Diff => _wave3Diff;
        [SerializeField, Min(-2)] private int _wave3Diff;
